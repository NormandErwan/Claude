...
| 2026-07-27 | Error handling | Validate-gate question unanswered -> wait silently (hook/notification noise isn't a reply) | `097ac94` | No (origin not logged) - part of a broader Error handling table addition, no individual reason given - retired (`9896a6b`, 2026-09-12): the harness cannot emit true silence, so the agent produced a meta-comment narrating the silence instead - noisier than the repeat it was meant to suppress |
