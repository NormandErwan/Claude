...
| 2026-08-24 | skill-gap | write-skill's own Skill Creation Checklist never checks its Naming rule (verb-first, gerunds, CSO section) - two skills built without it across two sessions | Add a checklist item under GREEN Phase, next to the existing character-set check, verifying verb-noun/gerund naming | pending | write-skill SKILL.md, Skill Creation Checklist |
